                  ...
                  <div className="row flex-v-align">
                    ...
                    <div className="col-sm-12 col-md-7 col-lg-7">
                      <div className="home-text hp-left">
                        ...
                        <h1>Alex Smith</h1>
                        <p>
                          Fusce tempor magna mi, non egestas velit ultricies
                          nec. Aenean convallis, risus non condimentum gravida,
                          odio mauris ullamcorper felis, ut venenatis purus ex
                          eu mi. Quisque imperdiet lacinia urna, a placerat
                          sapien pretium eu.
                        </p>
                  ...
                  <div className="info-block-w-icon">
                    ...
                    <div className="ci-text">
                      ...
                      <p>
                        ...
                        tellus. Mauris convallis dictum elit id volutpat.
                        Vivamus blandit, dolor vitae lacinia maximus, risus
                        velit vehicula odio, a tincidunt turpis turpis tempus
                        ex.
                      </p>
                    </div>
                  </div>
                ...
                >
                    ...
                    <div className="testimonial-content">
                      ...
                      <div className="testimonial-text">
                        <p>
                          ...
                          aliquet euismod mauris, a feugiat urna ullamcorper
                          non.
                        </p>
                      </div>
                      {/* <!-- /Testimonial Text --> */}
                  ...
                  <div className="testimonial-item">
                    ...
                    <div className="testimonial-content">
                      ...
                      <div className="testimonial-text">
                        <p>
                          Nam tempor commodo mi id sodales. Aenean sit amet nibh
                          nec sapien consequat porta a sit amet diam.
                        </p>
                      </div>
                      {/* <!-- /Testimonial Text --> */}
